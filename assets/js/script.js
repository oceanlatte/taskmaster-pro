...
$(".list-group").on("blur", "textarea", function () {
  ...
  //replace textarea with p elment
...
$(".card .list-group").sortable({
  ...
  update: function (event) {
    ...
    // loop over current set of children in the sortable list
    $(this)
      .children()
      .each(function () {
        ...
        // add task data to the temporary array as an object
        tempArr.push({
          text: text,
          date: date,
        });
